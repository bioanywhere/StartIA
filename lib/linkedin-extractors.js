...
export function extractIndividualProfile() {
  ...
  // Detect an authentication / join wall by URL, title, or body text. If the
  // background tab was redirected to a login/authwall page we must not treat
  // that page's URL as the contact's profile.
